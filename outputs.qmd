...
description: "Academic publications, policy briefs, and research outputs from the Desegpol project on school desegregation policies in Barcelona."
format: html
css: styles.css
toc: false
---
...
<img src="images/cover.jpeg" alt="Cover of policy brief: School desegregation policies in Barcelona – progress and remaining challenges" style="width: 100%; max-width: 250px; border-radius: 8px;"/>
:::
...
::::: {.publication-card style="display: flex; background-color: #fdfdfd; box-shadow: 0 0px 12px rgba(54,142,138,0.1); padding: 3rem; border-radius: 12px;"}
::: {style="flex: 1; margin-right: 1.5rem;"}
<img src="images/cover2.jpeg" alt="Cover of article: Emotional experiences and stigma among families benefiting from Barcelona&apos;s shock plan" style="width: 100%; max-width: 250px; border-radius: 8px;"/>
:::
...
::::: {.publication-card style="display: flex; background-color: #fdfdfd; box-shadow: 0 0px 12px rgba(54,142,138,0.1); padding: 3rem; border-radius: 12px;"}
::: {style="flex: 1; margin-right: 1.5rem;"}
<img src="images/cover3.jpg" alt="Cover of article: Redesigning choice to tackle school segregation – the impact of Barcelona&apos;s desegregation policies" style="width: 100%; max-width: 250px; border-radius: 8px;"/>
:::
